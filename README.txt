...
I am also currently adding a database using SQLite to see how data gets stored and how to add a db to this 
When creating database tables i have tried to keep in thought about normalization in db
Later on will try to connect to AWS
